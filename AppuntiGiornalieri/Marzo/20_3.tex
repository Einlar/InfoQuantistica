...
\end{align*}
Poiché vogliamo che le $\ket{\psi_i}$ esauriscano tutte le possibili evoluzioni di $\ket{\psi}$, richiediamo che le $p_i$ abbiano somma $1$, e quindi: \marginpar{Condizione di completezza}
\begin{align}
