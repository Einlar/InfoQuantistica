...
\index{Esercizio!Hamiltoniana NOT quantistica}
Per realizzare \textit{fisicamente} una porta logica dobbiamo trovare un \textit{sistema} che abbia la giusta Hamiltoniana per produrre l'evoluzione temporale desiderata. Si tratta, in altre parole, di risolvere l'equazione di Schr\"odinger dipendente dal tempo \q{al cotnrario}.\\
...
\end{enumerate}
%Dov'è il comportamento del NOT?
\end{document}
