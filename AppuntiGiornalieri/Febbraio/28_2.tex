...
Un'altra porta quantistica fondamentale (e \textit{senza analogo classico}) è quella che \q{aggiunge una fase relativa}, detta di \textbf{phase-shift}:\marginpar{Operatore phase-shift}\index{Porte logiche!Phase-shift}
\begin{align*}
...
\begin{expl}
\textbf{Porte logiche classiche}. Le porte logiche classiche a $1$ bit, essendo reversibili, possono essere adattate naturalmente al caso quantistico. In particolare il \textbf{buffer} è descritto da una matrice identità, mentre il NOT si ottiene \q{invertendo} le colonne (e righe) di $\bb{I}$:
\begin{align*}
...
Abbiamo accennato che in \MQ non è possibile copiare esattamente uno stato. Vediamo ora esattamente perché.\index{Teorema!No cloning}.\\
